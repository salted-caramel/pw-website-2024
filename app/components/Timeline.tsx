...
const Timeline = () => {
  return (
    <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical w-4/5 mx-auto">
      <li>
        ...
        <div className="timeline-start md:text-end mb-10">
          <time className="font-mono italic text-black">1984</time>
      ...
      <li>
        ...
        <div className="timeline-start md:text-end mb-10">
          ...
          <div className="text-lg font-black text-black">iPod</div>
          <p className="text-black">
      ...
      <li>
        ...
        <div className="timeline-start md:text-end mb-10">
          ...
          <div className="text-lg font-black text-black">Apple Watch</div>
          <p className="text-black">
